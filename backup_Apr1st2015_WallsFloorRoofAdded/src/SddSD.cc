...
// Modified to SddSD.cc at 2014-08-16 by Junhui Liao $
//
/// \file SddSD.cc
/// \brief Implementation of the SddSD class
...
SddSD::SddSD(G4String name)
: G4VSensitiveDetector(name), fHitsCollection(0), fHCID(-1)
{
     
    G4String HCname = "sddColl";
...
void SddSD::Initialize(G4HCofThisEvent* hce)
{
    fHitsCollection = new SddHitsCollection
...
G4bool SddSD::ProcessHits(G4Step* step, G4TouchableHistory*)
{
    ...
    {
        SddHit* hit = new SddHit(copyNo,hitTime);
        ///SddHit* hit = new SddHit(copyNo,hitTime,depositeE);///this method shows the E 
