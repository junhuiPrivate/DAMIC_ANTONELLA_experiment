...
// ********************************************************************
//
// Originally : $Id: HodoscopeSD.cc 76474 2013-11-11 10:36:34Z gcosmo $
// Modified to PmtshieldSD.cc at 2014-08-16 by Junhui Liao $
//
/// \file PmtshieldSD.cc
/// \brief Implementation of the PmtshieldSD class
...
PmtshieldSD::PmtshieldSD(G4String name)
: G4VSensitiveDetector(name), fHitsCollection(0), fHCID(-1)
{
     
    G4String HCname = "pmtshieldColl";
...
PmtshieldSD::~PmtshieldSD()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void PmtshieldSD::Initialize(G4HCofThisEvent* hce)
{
    fHitsCollection = new PmtshieldHitsCollection
...
G4bool PmtshieldSD::ProcessHits(G4Step* step, G4TouchableHistory*)
{
    ...
    {
        PmtshieldHit* hit = new PmtshieldHit(copyNo,hitTime);
        ///PmtshieldHit* hit = new PmtshieldHit(copyNo,hitTime,depositeE);///this method shows the E 
