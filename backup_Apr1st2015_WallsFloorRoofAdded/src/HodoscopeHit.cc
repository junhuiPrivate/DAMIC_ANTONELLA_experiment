...
G4ThreadLocal G4Allocator<HodoscopeHit>* HodoscopeHitAllocator=0;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
HodoscopeHit::HodoscopeHit(G4int i,G4double t)
: G4VHit(), fId(i), fTime(t), fLocalPos(0), fWorldPos(0) , fPLogV(0)
{}

///HodoscopeHit::HodoscopeHit(G4int i,G4double t,G4double e) /// This method shows all of E deposited
///: G4VHit(), fId(i), fEdep(e), fTime(t), fPos(0), fPLogV(0)/// by incident neutrons.
///{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

///HodoscopeHit::HodoscopeHit(G4int z)
///:  G4VHit(), fCellID(z), fEdep(0.),/* fEkin(0)*/, fPos(0), fPLogV(0)  /// Apparently, z is the ID of a cell.
///{}

HodoscopeHit::HodoscopeHit(G4int z)
:  G4VHit(), fCellID(z), fEdep(0.), fLocalPos(0), fWorldPos(0), fPLogV(0)  /// Apparently, z is the ID of a cell.
{}
...
void HodoscopeHit::Draw()
{
    ...
    if (pVVisManager&&(fEdep>0.))
    {
        ...
        G4Transform3D trans(fRot.inverse(),fWorldPos);
